...
namespace ConfigEditor.Forms
{
    public class EditGroupForm : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            _lblName = new Label { Text = "组名称(&N):", Location = new Point(12, 15), Size = new Size(80, 23) };
            _txtName = new TextBox { Location = new Point(100, 12), Size = new Size(250, 23) };

            _btnOk = new Button { Text = "确定", Location = new Point(190, 55), Size = new Size(75, 30) };
            _btnOk.Click += BtnOk_Click;

            _btnCancel = new Button { Text = "取消", Location = new Point(275, 55), Size = new Size(75, 30) };
        ...
        private void BtnOk_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("组名称不能为空。", "验证错误", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
